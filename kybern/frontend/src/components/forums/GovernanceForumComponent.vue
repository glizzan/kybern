<template>
    ...
    <span>
        ...
        <p>{{ forum_description }} of {{ group_name }}</p>
...
export default {
    ...
    computed: {
        ...
        forum_name: function() {
            if (this.forum_id && this.forums.length > 0) { return this.getForumData(this.forum_id).name }
            return undefined
        },
        forum_description: function() {
            if (this.forum_id && this.forums.length > 0) { return this.getForumData(this.forum_id).description }
            return undefined
        }
    },
    methods: {
