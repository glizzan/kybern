...
class ActionConditionsTestCase(BaseTestCase):
    ...
    def test_adding_condition_to_permission_generates_condition(self):
        ...
        # note: this is the second matching element because it's also in the info hover on permissions table
...
class TemplatesTestCase(BaseTestCase):
    ...
    def test_apply_template_with_no_conditions(self):
        ...
        self.browser.find_by_id("membership", wait_time=5).first.click()
        self.browser.find_by_id('group_membership_settings_button', wait_time=5).first.click()
        self.browser.find_by_id('edit_permissions_button_addmember').first.click()
    ...
    def test_apply_template_with_condition(self):
        ...
        self.browser.find_by_id('add_permission_button_default', wait_time=5).first.click()
        time.sleep(2)
        ...
        self.browser.find_by_id('governance_button', wait_time=5).first.click()
        self.browser.find_by_id("membership", wait_time=5).first.click()
        self.browser.find_by_id('group_membership_settings_button', wait_time=5)[0].click()
        self.browser.find_by_id('edit_permissions_button_addmember', wait_time=5)[0].scroll_to()
        permissions = [item.text for item in self.browser.find_by_css(".permission-display", wait_time=5)]
...
class ListTestCase(BaseTestCase):
    ...
    def test_list_functionality(self):
        ...
        self.browser.fill('name', "Best NWSL Teams")
        self.browser.fill('description', "The best NWSL teams, in order of awesomeness")
        ...
        self.browser.find_by_id('add_column_submit').first.click()
        time.sleep(.25)
        self.browser.find_by_css(".close", wait_time=5)[0].click()
        ...
        self.assertTrue(self.browser.is_text_present(text))
        self.assertEquals(len(self.browser.find_by_id('submit_add_row')), 0)
        ...
        self.browser.find_by_id('add_column_submit').first.click()
        self.assertTrue(self.browser.is_text_present("You have successfully added column 'Currently Active' to list."))
        self.browser.find_by_css(".close", wait_time=5)[1].click()
        ...
        self.assertTrue(self.browser.is_text_present("You have successfully edited row"))
        ...
        self.browser.find_by_id('edit_column_submit').first.click()
        self.assertTrue(self.browser.is_text_present("You have successfully edited column 'Team Name'"))
        self.browser.find_by_css(".close", wait_time=5)[1].click()
        ...
        self.browser.find_by_css(".custom-control-label").first.click()
        self.browser.find_by_id('edit_column_submit').first.click()
        text = "When making a column required, you must supply a default value unless your list is empty"
        self.assertTrue(self.browser.is_text_present(text))
        self.browser.find_by_css(".close", wait_time=5)[1].click()
        ...
        self.browser.find_by_id('delete_column_submit').first.click()
        self.browser.find_by_css(".close", wait_time=5)[1].click()
...
class DependentFieldTestCase(BaseTestCase):
    ...
    def test_make_dependent_field_from_scratch(self):
        ...
        self.browser.find_by_id("membership", wait_time=5).first.click()
        self.browser.find_by_id('group_membership_settings_button', wait_time=5).first.click()
        self.browser.find_by_id('add_permission_button_addmember', wait_time=5).first.click()
        time.sleep(4)
        self.select_from_multiselect("members")
        self.browser.find_by_id('save_permission_button', wait_time=5).first.click()
        time.sleep(1)
        self.browser.find_by_css(".close", wait_time=5).last.click()  # close modal
        self.browser.find_by_id('edit_permissions_button_addmember', wait_time=5).first.click()
